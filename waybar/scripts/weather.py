...
weather = requests.get("https://wttr.in/Brisbane?format=j1", timeout=7).json()
...
data['tooltip'] = f"<b>Now:</b>\n"
data['tooltip'] += f"{weather['current_condition'][0]['weatherDesc'][0]['value']}\n"
